...
urlpatterns = [
    ...
    path(
        "site-settings/",
        views.SiteSettingsAdminView.as_view(),
    ...
    path(
        ...
        views.AnnouncementToggleActiveView.as_view(),
        name="admin-announcement-toggle",
    ),
    # Homepage Sections
    path(
        "homepage-sections/",
        views.HomepageSectionListView.as_view(),
        name="admin-section-list",
    ),
    path(
        "homepage-sections/reorder/",
        views.HomepageSectionReorderView.as_view(),
        name="admin-section-reorder",
    ),
    path(
        "homepage-sections/<int:pk>/",
        views.HomepageSectionDetailView.as_view(),
        name="admin-section-detail",
    ),
    path(
        "homepage-sections/<int:pk>/toggle-active/",
        views.HomepageSectionToggleActiveView.as_view(),
    ...
    path(
        ...
        views.PostUnpublishView.as_view(),
        name="admin-post-unpublish",
    ),
    # Tags
    ...
    path(
        "posts/<int:pk>/editor/",
        views.PostEditorDetailView.as_view(),
        name="admin-post-editor",
    ),
    path(
        "posts/<int:post_pk>/files/",
        views.PostFileListCreateView.as_view(),
        name="admin-postfile-list",
    ),
    path(
        "posts/<int:post_pk>/files/<int:pk>/",
        views.PostFileDetailView.as_view(),
        name="admin-postfile-detail",
    ),
    # Comments
    ...
    path(
        ...
        views.CommentApproveView.as_view(),
        name="admin-comment-approve",
    ),
    path(
