...
class PositionDetailView(APIView):
    ...
    def _obj(self, pk): return get_object_or_404(Position, pk=pk)
...
class UserListView(APIView):
    ...
    def get(self, request):
        qs = User.objects.select_related("profile", "user_position").order_by("username")
...
class UserDetailView(APIView):
    ...
    def _obj(self, pk): return get_object_or_404(User, pk=pk)
