...
class PostFileAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "title", "description", "file", "file_url",
                  "file_type", "is_downloadable", "created_date"]
...
class CommentAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = [
            "id", "body", "status", "author_name", "post_title",
            "post_id", "parent_id", "parent_snippet",
            "like_count", "dislike_count", "is_edited",
            "created_date", "updated_date",
        ]
        read_only_fields = [
            "author_name", "post_title", "like_count", "dislike_count",
            "parent_snippet", "is_edited", "created_date", "updated_date",
        ]
    ...
    def get_like_count(self, obj):
        return obj.reactions.filter(reaction_type=CommentReaction.ReactionType.LIKE).count()
 
    def get_dislike_count(self, obj):
        return obj.reactions.filter(reaction_type=CommentReaction.ReactionType.DISLIKE).count()
