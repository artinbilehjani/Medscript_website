...
from .views import CaptchaView, RegisterView, LoginView,LogoutView,MeProfileView,ChangePasswordView,DeleteMeView,CsrfView
...
urlpatterns = [
    ...
    path("me/csrf/", CsrfView.as_view(), name="me-csrf"),
]