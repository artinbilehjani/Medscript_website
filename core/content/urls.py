...
from .views import PostListPageView,ArchivePageView,PostDetailPageView,PostListSearchPageView
...
urlpatterns = [
    ...
    path("posts/search/", PostListSearchPageView.as_view(), name="post-list-search-page"),
