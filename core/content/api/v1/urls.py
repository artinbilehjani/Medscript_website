from .views import CategoryNavigationView,PublicPostDetailAPIView,PublicPostListAPIView,PublicPostListSearchAPIView,FilterOptionsView
...
urlpatterns = [
    ...
    path("posts/search/", PublicPostListSearchAPIView.as_view(), name="public-post-list-search"),
